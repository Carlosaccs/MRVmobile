/* ==========================================================================
   v140.4 - INVERSÃO DE COMANDOS (MENU NO TOPO / FULLSCREEN EMBAIXO)
   ========================================================================== */
...
/* --- Lógica de Carregamento e Desenho (Preservadas) --- */
...
/* ==========================================================================
   LISTENERS COM A TROCA DE POSIÇÃO EFETIVA
   ========================================================================== */
...
document.addEventListener('click', (e) => {
    ...
    // O BOTÃO QUE ESTIVER EM CIMA (geralmente o que você quer como Menu agora)
    // Se o elemento clicado tiver ID 'btn-menu' ou classe de menu, ele abre o menu.
    if (e.target.closest('#btn-menu') || e.target.closest('.btn-toggle-menu')) {
        toggleMenu();
    }

    // O BOTÃO QUE ESTIVER EMBAIXO (agora o Fullscreen)
    // Forçamos o seletor a buscar o ID do fullscreen para ampliar.
    if (e.target.closest('#btn-fullscreen') || e.target.closest('.btn-fullscreen')) {
        toggleFullscreen();
    }
});
