...
async function carregarPlanilha() {
    ...
    try {
        ...
        // Split robusto para capturar todas as linhas (42 registros)
        ...
        console.log("✅ Banco carregado. Registros encontrados:", Object.keys(window.bancoDados).length);
        atualizarVisualizacao();
        popularMenuResidenciais(); // Atualiza o contador na faixa verde
    } catch (e) { 
        console.error("❌ Erro ao carregar planilha"); 
    }
}

// 3. LOGICA DO MENU LATERAL E CONTADOR
...
// 4. FUNÇÕES DE DESENHO E TROCA DE MAPA
